...
`16_ciudades.sql`, `17_razonsocial_lada.sql`, `18_producto_plus.sql`, `19_tienda_finanzas.sql`, `20_puntos_fidelizacion.sql`, `21_canje_puntos.sql`, `22_tienda_metas.sql`, `23_hidratacion.sql`, `24_hidratacion_bonus_idempotente.sql`, `25_club_membresia.sql`, `26_servicios_recargas.sql`, `27_academia_vida.sql`, `28_premios_vencimiento.sql`, `29_panel_operaciones.sql`. Checklist completo en **`DESPLIEGUE-VIDA.md`**.
