...
- **Fase 2 (PENDIENTE) — Panel LMS:** reescribir `frontend/src/pages/Academia.jsx` (catálogo + editor curso→módulos→lecciones + reproductor + comentarios).
- **Fase 3 (PENDIENTE) — Analítica + diplomas:** dashboard admin + constancia imprimible con QR.
- **Fase 4 (PENDIENTE) — Pulido / exponer en app cliente** (Audiencia CLIENTE/AMBOS ya modelada).
